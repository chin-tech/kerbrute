...
PACKAGENAME="github.com/chin-tech/kerbrute"
...
windows: ## Make Windows x86 and x64 Binaries
	@for ARCH in ${ARCHS}; do \
		...
		sha256sum ${TARGET}/kerbrute_windows_$${ARCH}.exe >> ${TARGET}/sha256.sum ;\
	done; \
	echo "Done."
...
linux: ## Make Linux x86 and x64 Binaries
	@for ARCH in ${ARCHS}; do \
		...
		sha256sum ${TARGET}/kerbrute_linux_$${ARCH} >> ${TARGET}/sha256.sum;\
	done; \
	echo "Done."
...
mac: ## Make Darwin (Mac) x86 and x64 Binaries
	@for ARCH in ${DARWIN_ARCHS}; do \
		...
		sha256sum ${TARGET}/kerbrute_darwin_$${ARCH} >> ${TARGET}/sha256.sum; \
	done; \
	echo "Done."

clean: ## Delete any binaries
	@rm -f ${TARGET}/* ; \
	go clean -i -n github.com/chin-tech/kerbrute ; \
	echo "Done."
